                ...
                <div class="row g-4 g-lg-5 align-items-center">
                    <div class="col-12 col-xl-6">
                        <div class="auth-register p-4 p-sm-5 rounded-3 border bg-white">
                            ...
                            <p>Don't have an account yet? <a href="auth-register.php"
                                    class="text-decoration-underline link-body-emphasis">Sign Up</a></p>
                            <div class="form-body mt-5">
                                <div class="row row-cols-1 g-3">
                                    ...
                                    <div class="col-md-6 text-end"><a href="auth-forgot.php"
                                            class="text-decoration-underline link-body-emphasis">Forgot Password ?</a>
                                    </div>
                                    <div class="col">
                                        <div class="d-grid">
                                            <a href="javascript:;" class="btn btn-dark btn-lg px-4 rounded-3"><span
                                                    class="fs-6">Login</span></a>
                                        </div>
                                    </div>
