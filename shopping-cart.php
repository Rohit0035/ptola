        ...
        <div class="container px-3">
            <nav>
                <ol class="breadcrumb mb-0 gap-2">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:;" class="breadcrumb-link">Cart</a></li>
                    <li><i class="bi bi-chevron-right"></i></li>
                    <li class="breadcrumb-item breadcrumb-active">Cart</li>
                </ol>
            </nav>
        </div>
    </section>
                    ...
                    <div class="cart-list d-flex flex-column gap-4">
                        <div
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <div class="cart-img">
                                    <img src="assets/images/gallery/tabular-product/07.png" class="rounded-3" width="80"
                                        alt="">
                                </div>
                                <div class="cart-product-info">
                                    <h5 class="product-name fs-6">Venic black pant</h5>
                            ...
                            <div class="cart-product-qty">
                                <p>Quantity</p>
                                <input type="number" class="form-control form-control-sm rounded-3 border-2 w-25"
                                    min="0" value="1">
                            </div>
                            <div class="btn border border-2 cart-product-btn-delete">
                        ...
                        <div
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <div class="cart-img">
                                    <img src="assets/images/gallery/tabular-product/03.png" class="rounded-3" width="80"
                                        alt="">
                                </div>
                                <div class="cart-product-info">
                                    <h5 class="product-name fs-6">Venic black pant</h5>
                        ...
                        <div
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <div class="cart-img">
                                    <img src="assets/images/gallery/tabular-product/06.png" class="rounded-3" width="80"
                                        alt="">
                                </div>
                                <div class="cart-product-info">
                                    <h5 class="product-name fs-6">Venic black pant</h5>
                        ...
                        <div
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <div class="cart-img">
                                    <img src="assets/images/gallery/tabular-product/04.png" class="rounded-3" width="80"
                                        alt="">
                                </div>
                                <div class="cart-product-info">
                                    <h5 class="product-name fs-6">Venic black pant</h5>
                    ...
                    <div class="card border-0 rounded-4 bg-light">
                        <div class="card-body">
                            <div class="checkout-card p-2">
                                ...
                                <div class="d-grid">
                                    <a href="checkout.php" class="btn btn-dark py-2 rounded-3">Proceed to checkout</a>
                                </div>
                            </div>
                        </div>
                    </div>
